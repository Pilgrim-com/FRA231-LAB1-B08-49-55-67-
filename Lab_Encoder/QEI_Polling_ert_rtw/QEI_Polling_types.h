...
#ifndef QEI_Polling_types_h_
#define QEI_Polling_types_h_
#include "rtwtypes.h"
...
typedef struct tag_RTM_QEI_Polling_T RT_MODEL_QEI_Polling_T;

#endif                                 /* QEI_Polling_types_h_ */
