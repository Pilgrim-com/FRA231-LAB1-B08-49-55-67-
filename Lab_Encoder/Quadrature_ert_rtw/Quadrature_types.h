...
#ifndef Quadrature_types_h_
#define Quadrature_types_h_
#include "rtwtypes.h"
...
typedef struct tag_RTM_Quadrature_T RT_MODEL_Quadrature_T;

#endif                                 /* Quadrature_types_h_ */
